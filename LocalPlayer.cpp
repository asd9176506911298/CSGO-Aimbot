...
{
	static uintptr_t engineModue = (uintptr_t)GetModuleHandle(L"engine.dll");
	static Vector3* viewAngles = (Vector3*)(*(uintptr_t*)(engineModue + hazedumper::signatures::dwClientState) + hazedumper::signatures::dwClientState_ViewAngles);
